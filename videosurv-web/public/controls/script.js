class Controls {
    ...
    controllers() {
        ...
        this.button(false, 'cog', (element) => {

            element.classList.toggle('active');
            var options = document.getElementById('options');
            var videoDiv = document.getElementById('map');
            options.classList.toggle('hide');
            videoDiv.classList.toggle('s8');
            videoDiv.classList.toggle('s12');
            ...
            setTimeout((that, camera) => {
                ...
                that._dish.video(camera, (element) => {
                    ...
                    video.addEventListener('click',()=>{
                        video.classList.toggle('focusedVideo');
                        this._focusedVideo = video == this._focusedVideo ? null:video;
                        this._focusedVideoIndex = index == this._focusedVideoIndex ? null:index;
                        console.log(this._focusedVideoIndex)
                    })
